...
import { Sparkles, ArrowRight, Zap, ShieldCheck, Compass, Users } from 'lucide-react';
...
export const SpotlightHero: React.FC<SpotlightHeroProps> = ({
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-3xl bg-[#030712] border border-slate-800 text-white p-8 md:p-14 shadow-2xl my-6">
      ...
      {/* 21st.dev Spotlight Directorial Ambient Beams */}
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))] from-indigo-900/30 via-purple-950/15 to-transparent pointer-events-none" />
      <div className="absolute -top-32 -left-32 w-96 h-96 rounded-full bg-[#5051F9]/15 blur-[100px] pointer-events-none" />
      ...
      <div 
        className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:32px_32px] opacity-30 [mask-image:radial-gradient(ellipse_60%_50%_at_50%_40%,#000_70%,transparent_100%)]" 
      />

      {/* Moving SVG Border Beam */}
      <BorderBeam size={320} duration={12} colorFrom="#5051F9" colorTo="#06B6D4" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-6">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-slate-900/90 border border-slate-800 text-[11px] text-slate-400 font-medium"
        >
          <Users className="w-3.5 h-3.5 text-emerald-400" />
          <span>Trusted by <strong>50,000+</strong> engineers preparing for FAANG & high-growth tech roles</span>
        </motion.div>
