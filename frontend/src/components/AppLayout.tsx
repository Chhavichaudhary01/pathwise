...
export default function AppLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F6FB] dark:bg-[#030712] text-slate-800 dark:text-slate-100 font-sans antialiased p-2 md:p-6 flex justify-center items-start transition-colors duration-200">
      <div className="w-full max-w-[1520px] bg-[#F8F9FD] dark:bg-[#0B0F19] rounded-3xl p-3 md:p-6 shadow-sm border border-slate-200/50 dark:border-slate-800/80 flex flex-col lg:flex-row gap-6 transition-colors duration-200">

        {/* Mobile Header Bar */}
        <div className="lg:hidden flex items-center justify-between bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-xs">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xl font-extrabold tracking-tight text-slate-900 dark:text-white">PathWise</span>
          </div>
          ...
          <div className="space-y-7">
            ...
            <div className="flex items-center justify-between px-2">
              <div className="flex items-center gap-2.5 cursor-pointer" onClick={() => navigate('/dashboard')}>
                ...
                <span className="text-xl font-black tracking-tight text-slate-900 dark:text-white">PathWise</span>
              </div>
              <ThemeToggle />
            </div>
            ...
            <div className="space-y-1.5">
              <span className="text-[10px] font-extrabold tracking-wider text-slate-400 dark:text-slate-500 uppercase px-3.5 mb-2 block">
                MAIN MENU
              </span>
                  ...
                  return (
                    <button
                      ...
                      className={`
                        ...
                        ${active
                          ? 'bg-white dark:bg-slate-900 text-[#5051F9] dark:text-indigo-400 font-bold shadow-xs border border-purple-100 dark:border-indigo-500/30'
                    ...
                    >
                      {active && (
                        <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1.5 h-6 bg-[#5051F9] dark:bg-indigo-400 rounded-r-full" />
                      )}
                      <Icon className={`w-4 h-4 transition-colors ${active ? 'text-[#5051F9] dark:text-indigo-400' : 'text-slate-400 group-hover:text-slate-600 dark:group-hover:text-slate-300'}`} />
            ...
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-4 border border-slate-100 dark:border-slate-800 shadow-2xs space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-extrabold uppercase tracking-wider text-slate-400 dark:text-slate-500">Student Profile</span>
                <button
                  onClick={() => {
          ...
          <header className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 self-end sm:self-auto">
              ...
              <button 
                ...
                className="w-9 h-9 rounded-full bg-white dark:bg-slate-900 border border-slate-200/70 dark:border-slate-800 flex items-center justify-center text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 shadow-2xs transition-colors cursor-pointer"
